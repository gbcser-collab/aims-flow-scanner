...
void main() {
  testWidgets('AIMS Flow Smart Scanner private CMR home renders without device approval gate', (tester) async {
    await tester.pumpWidget(const AimsFlowApp());
    await tester.pump(const Duration(milliseconds: 100));

    expect(find.text('Készülék jóváhagyásra vár'), findsNothing);
    expect(find.text('Hozzáférés visszavonva'), findsNothing);
