...
class NailFitV3SavedProfile {
      ...
      SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Mentett',
              style: TextStyle(fontFamily: 'serif', fontSize: 39, color: nfInk),
            ),
            Text(
              '${data.length} kedvenc stílus · ${c.saved.length} mentett look',
              style: const TextStyle(color: nfMuted, fontSize: 12),
            ),
            const SizedBox(height: 24),
            ...
            _collections(),
            const SizedBox(height: 24),
            nfSectionTitle('Kedvenc szettjeid', 'Összes megtekintése'),
            const SizedBox(height: 10),
            nfLookStrip(data, c),
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                ...
                _utility(Icons.settings_outlined, 'Beállítások'),
          ...
          itemBuilder: (_, i) => Container(
            ...
            child: Column(
              children: [
                Expanded(
                  child: nfPhoto(
                    premiumLooks[i].image,
                    tint: premiumLooks[i].color,
                  ),
                ),
                Padding(
          ...
          children: [
            Row(
              children: [
                const CircleAvatar(
                  radius: 52,
                  backgroundImage: NetworkImage(nfHeroUrl),
                  backgroundColor: Color(0xFFF4D6D8),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Text('Anna', style: TextStyle(fontFamily: 'serif', fontSize: 35, color: nfInk)),
                      const Text('Stílusprofil  ›', style: TextStyle(color: nfMuted, fontSize: 13)),
            ...
            Row(
              children: [
                Expanded(child: _stat(Icons.bookmark_border_rounded, '24', 'Mentett lookok')),
                Expanded(child: _stat(Icons.favorite_border_rounded, '17', 'Kedvencek')),
                Expanded(child: _stat(Icons.auto_awesome_rounded, '36', 'Próbák')),
              ],
            ),
          ],
        ),
  ...
  Widget _stat(IconData icon, String n, String label) => Column(
        children: [
          CircleAvatar(
            radius: 22,
            backgroundColor: const Color(0xFFF8DCE2),
            child: Icon(icon, color: nfInk, size: 20),
          ),
  ...
  Widget _utility(IconData icon, String label) => Container(
        ...
        child: Row(
          children: [
            CircleAvatar(
              radius: 18,
              backgroundColor: const Color(0xFFF8DCE1),
              child: Icon(icon, size: 18, color: nfInk),
            ),
  ...
  Widget _banner() => Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [Color(0xFFFFE7EB), Color(0xFFFFF3EF)],
          ),
        ...
        child: const Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('✦  BEAUTY AI', style: TextStyle(color: nfRoseDark, fontSize: 8, fontWeight: FontWeight.w800)),
            SizedBox(height: 8),
            Text('Személyre szabott ajánlás', style: TextStyle(fontFamily: 'serif', fontSize: 22, color: nfInk)),
            SizedBox(height: 4),
            Text('Fedezz fel új stílusokat a Te ízlésed alapján.', style: TextStyle(color: nfMuted, fontSize: 9.5)),
          ],
        ),
      );
}
